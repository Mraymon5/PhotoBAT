...
class DavRun:
    def __init__(self):
        ...
        self.shutterInitSteps = round(float([line[1] for line in paramsData if 'shutterInitSteps' in line[0]][0],0))
        ...
        self.tableInitSteps = round(float([line[1] for line in paramsData if 'tableInitSteps' in line[0]][0],0))
